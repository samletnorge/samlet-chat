...
var errorCannotDownloadChat = errors.New("We could not download your samlet-chat export file.")
...
var errorUnsupportedChatImportVersion = errors.New("Unsupported samlet-chat import format version.")
